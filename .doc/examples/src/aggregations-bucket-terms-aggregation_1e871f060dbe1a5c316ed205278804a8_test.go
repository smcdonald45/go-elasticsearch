...
func Test_aggregations_bucket_terms_aggregation_1e871f060dbe1a5c316ed205278804a8(t *testing.T) {
	es, _ := elasticsearch.NewDefaultClient()

	// tag:1e871f060dbe1a5c316ed205278804a8[]
	res, err := es.Search(
	...
	// end:1e871f060dbe1a5c316ed205278804a8[]
}
